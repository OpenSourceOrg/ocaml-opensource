...
(* OASIS_START *)
(* DO NOT EDIT (digest: 73c2976b059649a9fb61d0bb36d7a933) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/mehdid/ocaml-opensource";
          synopsis =
            "API Wrapper that allows you to query the Open Source License API with OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "ocaml-opensource is an API Wrapper that allows you to query the Open Source License API [1] with OCaml.";
                 OASISText.Para "[1]: https://api.opensource.org/"
              ];
          categories = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title =
                        "ocaml-opensource's documentation and API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title =
                        "\"ocaml-opensource's README.md and CHANGES files\"";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("README.md CHANGES", None)];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/mehdid/ocaml-opensource";
                      src_repo_browser =
                        Some "http://github.com/mehdid/ocaml-opensource";
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "J[\230\193[\217\165\220\192\134\207\142\144\179\159s";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
